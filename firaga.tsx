...
function processImage(imageData: ImageData, planSettings: PlanSettings) {
    const { mark } = timer();
...
function createPartListImage(palette: ColorAssignments, quantized: PalettizedImage): PartListImage {
...
function renderPlan(svg: SVGElement, image: PartListImage, planSettings: PlanSettings, displaySettings: DisplaySettings) {
...
type PartList = ReadonlyArray<PartListEntry>;
function getPartList(palette: ColorAssignments): PartList {
    const res = [];
