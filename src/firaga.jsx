...
const material_settings_1 = require("./material-settings");
const utils_1 = require("./utils");
const image_settings_1 = require("./image-settings");
...
const colorData = (0, color_data_1.loadColorData)();
...
function app() {
    let last = null;
    const imageSettingsComp = (0, image_settings_1.createImageSettingsComponent)(render);
    preact.render(imageSettingsComp.component(), document.getElementById("image-settings"));
    const materialSettingsComp = (0, material_settings_1.createMaterialSettingsComponent)(render);
    preact.render(materialSettingsComp.component(), document.getElementById("plan-settings"));
    ...
    function renderWorker() {
        ...
        showPartList(pli.partList, {
            pitch: (0, utils_1.getPitch)(materialSettings.size),
...
function adjustImage(imageData, imageSettings) {
    ...
    (0, image_utils_1.applyImageAdjustments)(rgbaArray, imageSettings.brightness, imageSettings.contrast, imageSettings.saturation);
    mark("Adjust image");
    return ({
        rgbaArray
    });
}
function palettizeImage(rgbaArray, imageSettings) {
    const { mark } = (0, utils_1.timer)();
    let allowedColors;
    switch (imageSettings.palette) {
    ...
    const palette = (0, palettizer_1.makePalette)(rgbaArray, allowedColors, imageSettings);
    mark("Create palette");
...
window.addEventListener("DOMContentLoaded", function () {
    ...
    (0, app_1.createApp)(props, document.getElementById("app-root"));
});
